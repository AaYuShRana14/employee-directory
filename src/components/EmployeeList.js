      ...
      <div className="overflow-x-auto shadow-lg rounded-lg" style={{ backgroundColor: '#8da9c4' }}>
        <table className="min-w-full border border-gray-300" style={{ backgroundColor: '#8da9c4' }}>
          <thead style={{ backgroundColor: '#6b8fa3' }}>
            <tr>
              <th className="px-6 py-3 text-left text-xs font-medium text-white uppercase tracking-wider border-b border-gray-400 text-[#1b263b]">
                Name
              </th>
              <th className="px-6 py-3 text-left text-xs font-medium text-white uppercase tracking-wider border-b border-gray-400 text-[#1b263b]">
                Role
              ...
              <th className="px-6 py-3 text-center text-xs font-medium text-white uppercase tracking-wider border-b border-gray-400 text-[#1b263b]">
                Actions
              </th>
            </tr>
          </thead>
